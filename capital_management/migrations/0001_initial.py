# Generated by Django 2.1.4 on 2020-02-21 14:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('open_date', models.DateField(verbose_name=' 建仓日期')),
                ('date', models.DateField(verbose_name='结算日起')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='capital_management.TradeLists', verbose_name='股票代码')),
            ],
            options={
                'verbose_name': '交易表现评价',
