# Generated by Django 2.1.4 on 2020-04-29 14:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.datetime(2020, 4, 29, 14, 14, 58, 876861), verbose_name='结算日期')),
            ],
            options={
                'verbose_name': '账户盈余表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('initial_capital', models.FloatField(verbose_name='期初资产')),
                ('date', models.DateField(default=datetime.datetime(2020, 4, 29, 14, 14, 58, 876236), verbose_name='创建日期')),
                ('broker', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='capital_management.Broker', verbose_name='证券公司')),
            ],
            options={
                'verbose_name': '证券资金账户',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='capital_management.Broker', verbose_name='证券账户')),
            ],
            options={
                'verbose_name': '清仓股票情况',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='capital_management.Broker', verbose_name='资金账户变化')),
            ],
            options={
                'verbose_name': '事件日志',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.datetime(2020, 4, 29, 14, 14, 58, 886502), verbose_name='更新日期')),
            ],
            options={
                'verbose_name': '行业强度监控',
                'get_latest_by': 'date',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('trade_date', models.DateField(default=datetime.datetime(2020, 4, 29, 14, 14, 58, 883592), verbose_name='交易日期')),
            ],
        ),
        migrations.CreateModel(
            name='Positions',
            fields=[
                ...
                ('open_date', models.DateField(verbose_name=' 建仓日期')),
                ('date', models.DateField(default=datetime.datetime(2020, 4, 29, 14, 14, 58, 880236), verbose_name='结算日起')),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='capital_management.Broker', verbose_name='资金账号')),
            ],
            options={
                'get_latest_by': 'date',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.datetime(2020, 4, 29, 14, 14, 58, 879507), verbose_name='结算日期')),
                ('update_flag', models.BooleanField(verbose_name='数据更新标志')),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='capital_management.Broker', verbose_name='证券账户')),
            ],
            options={
                'verbose_name': '股票持仓情况',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.datetime(2020, 4, 29, 14, 14, 58, 877948), verbose_name='交易日期')),
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='capital_management.Broker', verbose_name='交易账户')),
            ],
            options={
                'verbose_name': '股票交易记录',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(default=datetime.datetime(2020, 4, 29, 14, 14, 58, 878887), verbose_name='评价日期')),
        ...
        migrations.AddField(
            ...
            name='account',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='capital_management.Broker', verbose_name='账户名称'),
        ),
    ]
